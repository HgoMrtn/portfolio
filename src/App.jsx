...
export default function App() {
  ...
  return (
    <div className="flex flex-col items-center">
      {/* Hero Section */}
      <div className="flex flex-col bg-indigo-600 w-screen items-center">
      ...
      <div className="flex flex-col p-10 gap-16 max-w-5xl">
        <div className="flex flex-col gap-4">
          ...
          <h3>💻 Code Magic</h3>
          <p>
            JavaScript, Tailwind CSS, React.js, Node.js, MongoDB - you name it!
            I thrive on turning lines of code into interactive wonders.
          </p>
          ...
          <p>
            ...
            dream. Ready to see your project take flight? Let's create something
